const usersNames = ["Ahmed", "Mahmoud", "Tamer", "Mojanad"];
const users = [
  {
    id: 1,
    name: "Mahmoud Magdy",
    ...
    rate: 3.5,
    verified: true,
    description: "Experienced in building user interfaces using React and Vue.",
  },
  {
    id: 2,
    name: "John Doe",
...
>
  <div className="mb-2 flex items-center gap-3">
    ...
    <div className="center relative inline-block select-none whitespace-nowrap rounded-full bg-purple-500 py-1 px-2 align-baseline font-sans text-xs font-medium capitalize leading-none tracking-wide text-white">
      <div className="mt-px">Software Engineer</div>
    </div>
  </div>
